...
class Rossmann( object ):
    def __init__( self ):
        self.competition_distance_scaler   = pickle.load( open( 'C:/Users/santo/repos/DataScience-Em-Producao/parameter/competition_distance_scaler.pkl', 'rb' ) )
        self.competition_time_month_scaler = pickle.load( open( 'C:/Users/santo/repos/DataScience-Em-Producao/parameter/competition_time_month_scaler.pkl', 'rb' ) )
        self.promo_time_week_scaler        = pickle.load( open( 'C:/Users/santo/repos/DataScience-Em-Producao/parameter/promo_time_week_scaler.pkl', 'rb' ) )
        self.year_scaler                   = pickle.load( open( 'C:/Users/santo/repos/DataScience-Em-Producao/parameter/year_scaler.pkl', 'rb' ) )
        self.store_type_scaler             = pickle.load( open( 'C:/Users/santo/repos/DataScience-Em-Producao/parameter/store_type_scaler.pkl', 'rb' ) )

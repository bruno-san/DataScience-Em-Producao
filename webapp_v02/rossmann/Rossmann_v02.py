...
class Rossmann_v02( object ):
    def __init__( self ):
        self.competition_distance_scaler        = pickle.load( open( 'parameter02/competition_distance_scaler.pkl', 'rb' ) )
        self.competition_time_month_scaler      = pickle.load( open( 'parameter02/competition_time_month_scaler.pkl', 'rb' ) )
        self.competition_open_since_year_scaler = pickle.load( open( 'parameter02/competition_open_since_year_scaler.pkl', 'rb' ) )
        self.customers_scaler                   = pickle.load( open( 'parameter02/customers_scaler.pkl', 'rb' ) )
        self.promo_time_week_scaler             = pickle.load( open( 'parameter02/promo_time_week_scaler.pkl', 'rb' ) )
        self.year_scaler                        = pickle.load( open( 'parameter02/year_scaler.pkl', 'rb' ) )
        self.promo2_since_year_scaler           = pickle.load( open( 'parameter02/promo2_since_year_scaler.pkl', 'rb' ) )
        self.store_type_scaler                  = pickle.load( open( 'parameter02/store_type_scaler.pkl', 'rb' ) )
